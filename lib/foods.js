...
$('.food-table').on('click', '.food-item-delete-btn', function() {
  let food = $(event.target.parentNode)
...
$('.food-table').on('click', '.food-item-save-btn', function() {
  ...
  let newName = event.target.parentNode.parentNode.parentNode.firstElementChild.nextElementSibling.innerText
  let newCalories = parseInt(event.target.parentNode.parentNode.parentNode.firstElementChild.nextElementSibling.nextElementSibling.innerText)
...
const foodMaker = (tr) => {
  ...
  let foodName = collection[1].innerText
  let foodCalories = collection[2].innerText
